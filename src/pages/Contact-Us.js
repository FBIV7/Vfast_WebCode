      ...
      <div _ngcontent-sc6="" class="main">
        ...
        <app-contact-us-form _nghost-sc33="" class="ng-star-inserted">
          <div _ngcontent-sc33="" class="container">
            <h2 _ngcontent-sc33="" class="my-4">
              CONTACT US
            </h2>
            <div _ngcontent-sc33="" class="controlUsForm">
              <form
                _ngcontent-sc33=""
                class="mt-2 ng-untouched ng-pristine ng-invalid"
                novalidate=""
              >
                <mat-form-field
                  _ngcontent-sc33=""
                ...
                >
                  <div class="mat-form-field-wrapper">
                    ...
                    <div class="mat-form-field-underline ng-tns-c14-0 ng-star-inserted">
                    ...
                    <div class="mat-form-field-subscript-wrapper">
                      ...
                      {/* <!----> */}
                      <div
                        class="mat-form-field-hint-wrapper ng-tns-c14-0 ng-trigger ng-trigger-transitionMessages ng-star-inserted"
                ...
                >
                  <div class="mat-form-field-wrapper">
                    <div class="mat-form-field-flex">
                      ...
                      <div class="mat-form-field-infix">
                        <input
                          ...
                          onChange={(event) => {
                            this.onValueChanged(event, "mobile");
                          }}
                          id="mat-input-1141"
                          aria-invalid="false"
                          aria-required="false"
                    ...
                    <div class="mat-form-field-subscript-wrapper">
                      ...
                      {/* <!----> */}
                      <div
                        class="mat-form-field-hint-wrapper ng-tns-c14-1 ng-trigger ng-trigger-transitionMessages ng-star-inserted"
                        style={{ opacity: "1", transform: "translateY(0%)" }}
                      >
                        {/* <!----> */}
                        <div class="mat-form-field-hint-spacer"></div>
                ...
                >
                  <div class="mat-form-field-wrapper">
                    <div class="mat-form-field-flex">
                      ...
                      <div class="mat-form-field-infix">
                        <input
                          ...
                          onChange={(event) => {
                            this.onValueChanged(event, "email");
                          }}
                          id="mat-input-1142"
                          aria-invalid="false"
                          aria-required="false"
                    ...
                    {/* <!----> */}
                    <div class="mat-form-field-underline ng-tns-c14-2 ng-star-inserted">
                      <span class="mat-form-field-ripple"></span>
                    </div>
                    <div class="mat-form-field-subscript-wrapper">
                      {/* <!----> */}
                      {/* <!----> */}
                      <div
                        class="mat-form-field-hint-wrapper ng-tns-c14-2 ng-trigger ng-trigger-transitionMessages ng-star-inserted"
                        style={{ opacity: "1", transform: "translateY(0%)" }}
                      >
                        {/* <!----> */}
                        <div class="mat-form-field-hint-spacer"></div>
                ...
                >
                  <div class="mat-form-field-wrapper">
                    <div class="mat-form-field-flex">
                      ...
                      <div class="mat-form-field-infix">
                        <input
                          ...
                          onChange={(event) => {
                            this.onValueChanged(event, "company");
                          }}
                          id="mat-input-1143"
                          aria-invalid="false"
                          aria-required="false"
                    ...
                    <div class="mat-form-field-subscript-wrapper">
                      ...
                      {/* <!----> */}
                      <div
                        class="mat-form-field-hint-wrapper ng-tns-c14-3 ng-trigger ng-trigger-transitionMessages ng-star-inserted"
                        style={{ opacity: "1", transform: "translateY(0%)" }}
                      >
                        {/* <!----> */}
                        <div class="mat-form-field-hint-spacer"></div>
                ...
                >
                  <div class="mat-form-field-wrapper">
                    <div class="mat-form-field-flex">
                      <div class="mat-form-field-infix">
                        <select
                          ...
                          onChange={(event) => {
                            this.onValueChanged(event, "employees");
                          }}
                        >
                          <option
                            value=""
                            className="ng-tns-c34-5 ng-star-inserted"
                          >
                            Select No of Employees
                          </option>
                          <option
                            value=""
                            className="mat-select-value-text ng-tns-c6-5 ng-star-inserted"
                          >
                            1-10
                          </option>
                          <option value="" className="mat-option-text">
                            100-500
                          </option>
                          <option value="" className="mat-option-text">
                            above 500
                    ...
                    <div class="mat-form-field-subscript-wrapper">
                      <div
                        class="mat-form-field-hint-wrapper ng-tns-c14-4 ng-trigger ng-trigger-transitionMessages ng-star-inserted"
                        style={{ opacity: "1", transform: "translateY(0%)" }}
                      >
                        {/* <!----> */}
                        <div class="mat-form-field-hint-spacer"></div>
                ...
                >
                  <div class="mat-form-field-wrapper">
                    <div class="mat-form-field-flex">
                      <div class="mat-form-field-infix">
                        <select
                          ...
                          onChange={(event) => {
                            this.onValueChanged(event, "department");
                          }}
                        >
                          <option
                            value=""
                    ...
                    {/* <!----> */}
                    <div class="mat-form-field-underline ng-tns-c14-6 ng-star-inserted">
                      <span class="mat-form-field-ripple"></span>
                    </div>
                    <div class="mat-form-field-subscript-wrapper">
                      {/* <!----> */}
                ...
                >
                  <div class="mat-form-field-wrapper">
                    <div class="mat-form-field-flex">
                      ...
                      <div class="mat-form-field-infix">
                        <textarea
                          ...
                          onChange={(event) => {
                            this.onValueChanged(event, "message");
                          }}
                        ></textarea>
                        <span class="mat-form-field-label-wrapper">
                          {/* <!----> */}
                    ...
                    {/* <!----> */}
                    <div class="mat-form-field-underline ng-tns-c14-8 ng-star-inserted">
                      <span class="mat-form-field-ripple"></span>
                    </div>
                    <div class="mat-form-field-subscript-wrapper">
                      {/* <!---->
                ...
                <div _ngcontent-sc33="" class="ml-3">
                  <button
                    _ngcontent-sc33=""
                    color="primary"
                    mat-raised-button=""
                    class="mat-raised-button mat-primary _mat-animation-noopable"
                  >
              ...
              <div _ngcontent-sc33="" class="disclaimer mt-5 p-2">
                <p _ngcontent-sc33="">
                  <strong _ngcontent-sc33="">Disclaimer: </strong>By submitting
                  this form, you agree to our company (FBIV Infocomm Pvt Ltd)
                  Terms &amp; Conditions, under that VFAST can contact you for
                  the products and services by our entire modes of communication
                  regardless you’re registered and listed on DND (Do Not
                  Disturb) or DNC (Do Not Call) services.
                </p>
              </div>
              <hr _ngcontent-sc33="" />
              <div _ngcontent-sc33="" class="details">
                <div _ngcontent-sc33="" class="box">
                  <i _ngcontent-sc33="" class="fas fa-map-marker-alt"></i>
                  <div _ngcontent-sc33="">
                    ...
                    <p _ngcontent-sc33="">
                      ...
                      <br _ngcontent-sc33="" /> D-2/6, Krishna Nagar,
                      Delhi-110051
                    </p>
                  </div>
                </div>
                <div _ngcontent-sc33="" class="box">
                  <i _ngcontent-sc33="" class="fas fa-envelope"></i>
                  <div _ngcontent-sc33="">
                    <h4 _ngcontent-sc33="">Email</h4>
                    <a _ngcontent-sc33="" href="mailto:info@vfast.in">
                      info@vfast.in
                    </a>
                  </div>
                </div>
                <div _ngcontent-sc33="" class="box">
                  <i _ngcontent-sc33="" class="fas fa-phone"></i>
                  <div _ngcontent-sc33="">
                    <h4 _ngcontent-sc33="">Contact No.</h4>
                    <a _ngcontent-sc33="" href="tel:+91-1141002777">
                      +91 11 410 02777
                    </a>
                    <br _ngcontent-sc33="" />
                    <a _ngcontent-sc33="" href="tel:+91-1145502777">
                      +91 11 455 02777
                    </a>
                  </div>
                </div>
              ...
              <div _ngcontent-sc33="" class="display my-2">
                <div _ngcontent-sc33="" style={{ fontSize: "18px" }}>
                  <strong _ngcontent-sc33="">GSTIN : </strong> 07AADCF7200K1ZR
                </div>
                <div _ngcontent-sc33="" style={{ fontSize: "18px" }}>
                  <strong _ngcontent-sc33="">CIN No :</strong>
                  U74999DL2019PTC349308{" "}
                </div>
                <div _ngcontent-sc33="" style={{ fontSize: "18px" }}>
                  <strong _ngcontent-sc33="">Toll Free No : </strong>1800 572
                  7797
                </div>
              </div>
            </div>
